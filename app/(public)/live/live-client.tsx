...
import type { LiveShow } from "@workspace/db";
...
export function LiveClient({ shows }: { shows: LiveShow[] }) {
          ...
          <div className="space-y-4">
            {upcoming.map((show) => (
              ...
              >
                ...
                {show.ticketUrl ? (
                  // This project's Button has no Slot/asChild support, so render a
                  // link styled as a button (valid <a>, identical appearance).
                  <a
                    href={show.ticketUrl}
                    target="_blank"
