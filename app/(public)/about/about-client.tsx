...
import type { ArtistInfo } from "@workspace/db";
...
export function AboutClient({ artistInfo }: { artistInfo: ArtistInfo | null }) {
    ...
    <div className="w-full pt-24 pb-12 px-6 md:px-12 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-32 mt-12">
        ...
        >
          ...
          <img
            src={artistInfo?.aboutPortraitUrl?.trim() || "/images/about-portrait.png"}
