const PRIMARY = "#9B8AC4";
const PRIMARY_DIM = "#7f6faa";
...
export function DustyViolet() {
  return (
    <div style={{ background: BG, color: FG, fontFamily: "Inter, sans-serif", minHeight: "100vh", overflow: "hidden" }}>

      {/* Navbar */}
      <nav style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "20px 48px", borderBottom: `1px solid rgba(155,138,196,0.1)` }}>
      ...
      <div style={{ position: "relative", padding: "70px 48px 60px", textAlign: "center", overflow: "hidden" }}>
        {/* Ambient glow */}
        <div style={{ position: "absolute", top: "30%", left: "50%", transform: "translate(-50%,-50%)", width: 600, height: 400, background: `radial-gradient(ellipse, ${PRIMARY}1a 0%, transparent 70%)`, pointerEvents: "none" }} />
        ...
        <h1 style={{ fontFamily: "'Cinzel', serif", fontSize: 62, fontWeight: 700, lineHeight: 1.05, letterSpacing: "0.06em", textTransform: "uppercase", background: `linear-gradient(135deg, ${PRIMARY_DIM}, ${PRIMARY}, #b8a8da)`, WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", margin: "0 0 8px" }}>
          Fretless
        </h1>
      ...
      <div style={{ padding: "0 48px", display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 16 }}>
        {[
          ...
          <div key={i} style={{ background: CARD, border: `1px solid rgba(155,138,196,0.14)`, padding: "20px", position: "relative" }}>
