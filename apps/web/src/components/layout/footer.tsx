...
export function Footer() {
  return (
    <footer className="bg-background border-t border-secondary/10 py-16 mt-20">
      <div className="max-w-7xl mx-auto px-6 md:px-12 grid grid-cols-1 md:grid-cols-4 gap-12">
        <div className="col-span-1 md:col-span-2">
          <Link href="/" className="font-display font-bold text-2xl tracking-[0.2em] text-foreground mb-6 block">
            FOUNTAINHEAD
          </Link>
        ...
        <div>
          ...
          <ul className="space-y-4">
            <li><Link href="/quote?service=mixing-mastering" className="text-muted-foreground hover:text-primary transition-colors">Mixing & Mastering</Link></li>
            <li><Link href="/quote?service=production" className="text-muted-foreground hover:text-primary transition-colors">Production</Link></li>
